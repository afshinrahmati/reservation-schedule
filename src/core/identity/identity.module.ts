...
import { TypeOrmModule } from '@nestjs/typeorm'; import { JwtModule } from '@nestjs/jwt';
import { UserEntity } from './domain/models/user.entity'; import { RoleEntity } from './domain/models/role.entity';
import { UserRepoPort } from './application/ports/user-repo.port'; import { RoleRepoPort } from './application/ports/role-repo.port';
import { HasherPort } from './application/ports/hasher.port'; import { JwtPort } from './application/ports/jwt.port';
import { BcryptHasherAdapter } from './infrastructure/security/bcrypt-hasher.adapter'; import { NestJwtAdapter } from './infrastructure/security/nest-jwt.adapter';
...
import {RoleSeeder} from "@/infrastructure/seeds/role.seeder";
...
@Module({
    imports: [CqrsModule, TypeOrmModule.forFeature([UserEntity, RoleEntity]), EventBusModule,AuthApiModule],
