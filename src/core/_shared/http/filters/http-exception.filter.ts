...
export class GlobalHttpExceptionFilter implements ExceptionFilter {
    ...
    if (exception instanceof AppError) {
      ...
      body = { traceId, code: exception.code, message: exception.message, details: exception.details ?? null };
      ...
      body = { traceId, code: 'UNCAUGHT.EXCEPTION', message: exception.message };
    }
...
function mapStatusToDefaultCode(status: number) {
  switch (status) {
    ...
    default: return 'INTERNAL.SERVER_ERROR';
  }
}
